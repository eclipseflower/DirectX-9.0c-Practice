...
PointLightDemoApp::PointLightDemoApp(HINSTANCE hInstance, std::string winCaption, D3DDEVTYPE devType, DWORD requestedVP) : D3DApp(hInstance, winCaption, devType, requestedVP)
{
	if (!CheckDeviceCaps())
	{
...
PointLightDemoApp::~PointLightDemoApp()
{
	delete mGfxStats;
	ReleaseCOM(mVb);
	ReleaseCOM(mIb);
...
bool PointLightDemoApp::CheckDeviceCaps()
{
	D3DCAPS9 caps;
...
void PointLightDemoApp::OnLostDevice()
{
	mGfxStats->OnLostDevice();
	HR(mFx->OnLostDevice());
}

void PointLightDemoApp::OnResetDevice()
{
...
void PointLightDemoApp::UpdateScene(float dt)
{
	mGfxStats->Update(dt);
...
void PointLightDemoApp::DrawScene()
{
...
void PointLightDemoApp::BuildGeoBuffers()
{
...
void PointLightDemoApp::BuildFx()
{
	ID3DXBuffer* errors = 0;
	HR(D3DXCreateEffectFromFile(gD3dDevice, "pointlight.fx", 0, 0, D3DXSHADER_DEBUG, 0, &mFx, &errors));
	if (errors)
...
void PointLightDemoApp::BuildViewMtx()
{
...
void PointLightDemoApp::BuildProjMtx()
{
...
void PointLightDemoApp::DrawGrid()
{
...
void PointLightDemoApp::DrawCylinders()
{
...
void PointLightDemoApp::DrawSpheres()
{
	D3DXMATRIX W, WIT;
